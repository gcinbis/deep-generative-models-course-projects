...
# May, 2020
# --------------------------------------------------
# Following code is adopted from https://github.com/mseitzer/pytorch-fid
# --------------------------------------------------
...
def fid_inception_v3():
    ...
    inception = torchvision.models.inception_v3(num_classes=1008, aux_logits=False, pretrained=False)
